...
def save_pyplot_add_to_doc(plot, plot_name, section_name, working_doc, caption="", dpi=250):
...
def save_plotly_add_to_doc(plot, plot_name, section_name, working_doc, caption="", scale=4.0):
